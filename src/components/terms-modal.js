          ...
          <View>
            <View style={{ backgroundColor: '#fff', padding: 20, borderRadius: 4, alignItems: 'center' }}>
              <View style={styles.profileDetail}>
                ...
                <Text style={{ color: '#000', opacity: 0.5, marginTop: 5 }}>Any side effect, health issues, harm or damage caused by the food from delivery restaurant/facility will not be the responsibility of Food All-In-One and/or dine-in restaurant/facility. </Text>
